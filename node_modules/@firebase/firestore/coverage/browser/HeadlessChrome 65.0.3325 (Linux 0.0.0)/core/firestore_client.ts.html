...
<html lang="en">
<head>
    <title>Code coverage report for core/firestore_client.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> firestore_client.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.35% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>103/114</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">89.22% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>91/102</span>
      </div>
    </div>
  </div>
...
&nbsp;
    ...
    this.credentials.setUserChangeListener(user =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!initialized) {
        initialized = true;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.asyncQueue.enqueue(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >          return this.handleUserChange(user);</span>
        });
      }
    });
&nbsp;
  ...
  private initializePersistence(
    ...
    if (usePersistence) {
      return this.startIndexedDbPersistence()
        ...
        .catch(<span class="fstat-no" title="function not covered" >(</span>error: FirestoreError) =&gt; {
          // Regardless of whether or not the retry succeeds, from an user
          // perspective, offline persistence has failed.
<span class="cstat-no" title="statement not covered" >          persistenceResult.reject(error);</span>
&nbsp;
          // An unknown failure on the first stage shuts everything down.
<span class="cstat-no" title="statement not covered" >          if (!this.canFallback(error)) {</span>
...
<span class="cstat-no" title="statement not covered" >          return this.startMemoryPersistence();</span>
        });
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private canFallback(</span>error: FirestoreError): boolean {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleUserChange(</span>user: User): Promise&lt;void&gt; {
<span class="cstat-no" title="statement not covered" >    this.asyncQueue.verifyOperationInProgress();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    debug(LOG_TAG, 'User Changed: ' + user.uid);</span>
<span class="cstat-no" title="statement not covered" >    return this.syncEngine.handleUserChange(user);</span>
  }
&nbsp;
