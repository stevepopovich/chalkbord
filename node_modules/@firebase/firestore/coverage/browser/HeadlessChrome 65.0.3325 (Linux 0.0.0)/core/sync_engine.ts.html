...
<html lang="en">
<head>
    <title>Code coverage report for core/sync_engine.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> sync_engine.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.57% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>232/233</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>219/220</span>
      </div>
    </div>
  </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1105x</span>
<span class="cline-any cline-yes">56x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1807x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1807x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2491x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  private updateTrackedLimbos(
    ...
    for (const limboChange of limboChanges) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (limboChange instanceof RemovedLimboDocument) {
        log.debug(LOG_TAG, 'Document no longer in limbo: ' + limboChange.key);
        this.limboDocumentRefs.removeReference(limboChange.key, targetId);
      } else {
<span class="cstat-no" title="statement not covered" >        fail('Unknown limbo change: ' + JSON.stringify(limboChange));</span>
      }
    }
    return this.gcLimboDocuments();
  }
&nbsp;
  private trackLimboChange(limboChange: AddedLimboDocument): void {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.limboTargetsByKey.get(key)) {
