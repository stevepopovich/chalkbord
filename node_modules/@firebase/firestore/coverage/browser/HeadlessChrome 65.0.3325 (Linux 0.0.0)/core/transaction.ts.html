...
<html lang="en">
<head>
    <title>Code coverage report for core/transaction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> transaction.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  private recordVersion(doc: MaybeDocument) {
    ...
    if (existingVersion !== null) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!docVersion.isEqual(existingVersion)) {
...
&nbsp;
  lookup(keys: DocumentKey[]): Promise&lt;MaybeDocument[]&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.committed) {
<span class="cstat-no" title="statement not covered" >      return Promise.reject&lt;MaybeDocument[]&gt;(</span>
