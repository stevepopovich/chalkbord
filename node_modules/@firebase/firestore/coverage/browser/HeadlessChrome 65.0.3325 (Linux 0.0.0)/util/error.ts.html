...
<html lang="en">
<head>
    <title>Code coverage report for util/error.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">util</a> error.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(readonly code: Code, readonly message: string) {
    super(message)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
