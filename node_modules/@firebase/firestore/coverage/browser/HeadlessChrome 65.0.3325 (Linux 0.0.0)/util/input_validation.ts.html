...
<html lang="en">
<head>
    <title>Code coverage report for util/input_validation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">util</a> input_validation.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.53% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>77/86</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>76/85</span>
      </div>
    </div>
  </div>
...
366
367
368</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2325x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">906x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1351x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4029x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">7314x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">930x</span>
<span class="cline-any cline-yes">8x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">3123x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2147x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">207x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">769x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
export function validateNamedArrayAtLeastNumberOfElements&lt;T&gt;(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(value instanceof Array) || value.length &lt; minNumberOfElements) {
...
export function validateNamedOptionalPropertyEquals&lt;T&gt;(
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (input !== undefined) {
...
export function valueDescription(input: AnyJs) {
  if (input === undefined) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (input.length &gt; 20) {
<span class="cstat-no" title="statement not covered" >      input = `${input.substring(0, 20)}...`;</span>
    }
    ...
    if (input instanceof Array) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (customObjectName) {
        return `a custom ${customObjectName} object`;
      } else {
<span class="cstat-no" title="statement not covered" >        return 'an object';</span>
      }
    }
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof input === 'function') {
    return 'a function';
  } else {
<span class="cstat-no" title="statement not covered" >    return fail('Unknown wrong type: ' + typeof input);</span>
  }
}
&nbsp;
/** Hacky method to try to get the constructor name for an object. */
export function tryGetCustomObjectType(input: object): string | null {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (input.constructor) {
    const funcNameRegex = /function\s+([^\s(]+)\s*\(/;
    const results = funcNameRegex.exec(input.constructor.toString());
    <span class="missing-if-branch" title="else path not taken" >E</span>if (results &amp;&amp; results.length &gt; 1) {
      return results[1];
    }
  }
...
export function validateDefined(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (argument === undefined) {
<span class="cstat-no" title="statement not covered" >    throw new FirestoreError(</span>
      Code.INVALID_ARGUMENT,
 ...
 * an instanceof check.
 */
<span class="fstat-no" title="function not covered" >export function invalidClassError(</span>
  functionName: string,
  type: string,
  position: number,
  argument: AnyJs
): Error {
  const description = <span class="cstat-no" title="statement not covered" >valueDescription(argument);</span>
<span class="cstat-no" title="statement not covered" >  return new FirestoreError(</span>
    Code.INVALID_ARGUMENT,
...
<span class="cstat-no" title="statement not covered" >      return 'third';</span>
    default:
      return num + 'th';
  }
}
