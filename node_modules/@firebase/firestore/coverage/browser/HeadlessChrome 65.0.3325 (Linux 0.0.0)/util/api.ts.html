...
<html lang="en">
<head>
    <title>Code coverage report for util/api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">util</a> api.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  for (const staticProperty in cls) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (cls.hasOwnProperty(staticProperty)) {
