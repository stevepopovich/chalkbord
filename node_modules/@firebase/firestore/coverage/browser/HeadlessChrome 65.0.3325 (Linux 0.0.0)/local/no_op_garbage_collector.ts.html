...
<html lang="en">
<head>
    <title>Code coverage report for local/no_op_garbage_collector.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">local</a> no_op_garbage_collector.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  removeGarbageSource(</span>garbageSource: GarbageSource): void {
    // Not tracking garbage so don't track sources.
  }
&nbsp;
