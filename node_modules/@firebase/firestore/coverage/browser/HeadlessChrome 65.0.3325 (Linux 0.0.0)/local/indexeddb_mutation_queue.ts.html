...
<html lang="en">
<head>
    <title>Code coverage report for local/indexeddb_mutation_queue.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">local</a> indexeddb_mutation_queue.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.24% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>211/217</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">96.89% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>187/193</span>
      </div>
    </div>
  </div>
...
597
598
599</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">398x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1169x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">644x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3119x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2251x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6165x</span>
<span class="cline-any cline-yes">6165x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        ...
        return mutationsStore(transaction)
          .get(mutationKey)
          .next(dbBatch =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (dbBatch === null) {
        ...
        uniqueBatchIDs.forEach(batchID =&gt; {
          ...
          promises.push(
            mutationsStore(transaction)
              .get(mutationKey)
              .next(mutation =&gt; {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (mutation === null) {
<span class="cstat-no" title="statement not covered" >                  fail(</span>
                    'Dangling document-mutation reference found, ' +
                      'which points to ' +
                      mutationKey
...
&nbsp;
      ...
      return documentMutationsStore(txn)
        .iterate({ range: startRange }, (key, _, control) =&gt; {
          const userID = key[0];
          <span class="missing-if-branch" title="else path not taken" >E</span>if (userID !== this.userId) {
            control.done();
            return;
          } else {
            const path = <span class="cstat-no" title="statement not covered" >EncodedResourcePath.decode(key[1]);</span>
<span class="cstat-no" title="statement not covered" >            danglingMutationReferences.push(path);</span>
          }
        })
        .next(() =&gt; {
          assert(
            ...
            'Document leak -- detected dangling mutation references when queue is empty. Dangling keys: ' +
              danglingMutationReferences.map(<span class="fstat-no" title="function not covered" >p =&gt; <span class="cstat-no" title="statement not covered" >p.canonicalString())</span></span>
          );
        });
    });
  }
...
function getStore&lt;KeyType extends IDBValidKey, ValueType&gt;(
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (txn instanceof SimpleDbTransaction) {
    return txn.store&lt;KeyType, ValueType&gt;(store);
  } else {
<span class="cstat-no" title="statement not covered" >    return fail('Invalid transaction object provided!');</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
