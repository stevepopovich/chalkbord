...
<html lang="en">
<head>
    <title>Code coverage report for local/indexeddb_schema.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">local</a> indexeddb_schema.ts
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">99.07% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>106/107</span>
      </div>
    </div>
  </div>
...
function ensureTargetGlobalExists(
  ...
  return globalStore.get(DbTargetGlobal.key).next(metadata =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (metadata != null) {
<span class="cstat-no" title="statement not covered" >      return PersistencePromise.resolve(metadata);</span>
    } else {
