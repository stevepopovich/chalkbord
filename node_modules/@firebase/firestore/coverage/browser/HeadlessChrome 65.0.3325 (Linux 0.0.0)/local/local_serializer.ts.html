...
<html lang="en">
<head>
    <title>Code coverage report for local/local_serializer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">local</a> local_serializer.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">946x</span>
...
&nbsp;
  ...
  fromDbRemoteDocument(remoteDoc: DbRemoteDocument): MaybeDocument {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (remoteDoc.noDocument) {
...
<span class="cstat-no" title="statement not covered" >      return fail('Unexpected DbRemoteDocument');</span>
    }
  }
&nbsp;
