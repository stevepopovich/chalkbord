...
<html lang="en">
<head>
    <title>Code coverage report for platform/config.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">platform</a> config.ts
    </h1>
    <div class='clearfix'>
 ...
 * as a goog module.
 */
<span class="fstat-no" title="function not covered" >export function configureForStandalone(</span>exportObject: {
  [key: string]: {};
}): void {
  const copiedNamespace = <span class="cstat-no" title="statement not covered" >shallowCopy(firestoreNamespace);</span>
  // Unlike the use with Firebase, the standalone allows the use of the
  // constructor, so export it's internal class
<span class="cstat-no" title="statement not covered" >  copiedNamespace['Firestore'] = Firestore;</span>
<span class="cstat-no" title="statement not covered" >  exportObject['firestore'] = copiedNamespace;</span>
}
&nbsp;</pre></td></tr>
</table></pre>
