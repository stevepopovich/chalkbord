...
<html lang="en">
<head>
    <title>Code coverage report for api/blob.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">api</a> blob.ts
    </h1>
    <div class='clearfix'>
...
function assertUint8ArrayAvailable() {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof Uint8Array === 'undefined') {
...
function assertBase64Available() {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!PlatformSupport.getPlatform().base64Available) {
<span class="cstat-no" title="statement not covered" >    throw new FirestoreError(</span>
      Code.UNIMPLEMENTED,
...
<span class="cstat-no" title="statement not covered" >      throw invalidClassError('Blob.fromUint8Array', 'Uint8Array', 1, array);</span>
    }
