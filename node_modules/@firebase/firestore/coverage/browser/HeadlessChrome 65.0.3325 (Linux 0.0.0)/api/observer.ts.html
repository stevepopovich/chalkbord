...
<html lang="en">
<head>
    <title>Code coverage report for api/observer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">api</a> observer.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  for (const method of methods) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (method in object &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof object[method] === 'function')</span> {
