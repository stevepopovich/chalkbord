...
<html lang="en">
<head>
    <title>Code coverage report for model/mutation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">model</a> mutation.ts
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">94.71% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>179/189</span>
      </div>
    </div>
  </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2544x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">1450x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1264x</span>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1648x</span>
<span class="cline-any cline-yes">1648x</span>
<span class="cline-any cline-yes">1648x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1648x</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  isEqual(</span>other: TransformOperation): boolean {
<span class="cstat-no" title="statement not covered" >    return other instanceof ServerTimestampTransform;</span>
  }
}
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  isEqual(</span>other: FieldTransform): boolean {
...
&nbsp;
  ...
  isValidFor(maybeDoc: MaybeDocument | null) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.updateTime !== undefined) {
<span class="cstat-no" title="statement not covered" >      return (</span>
        maybeDoc instanceof Document &amp;&amp;
        maybeDoc.version.isEqual(this.updateTime)
      );
    } else if (this.exists !== undefined) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.exists) {
        return maybeDoc instanceof Document;
      } else {
<span class="cstat-no" title="statement not covered" >        return maybeDoc === null || maybeDoc instanceof NoDocument;</span>
      }
    } else {
...
&nbsp;
  applyToLocalView(
    ...
    this.verifyKeyMatches(maybeDoc);
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.precondition.isValidFor(maybeDoc)) {
<span class="cstat-no" title="statement not covered" >      return maybeDoc;</span>
    }
&nbsp;
    const version = Mutation.getPostMutationVersion(maybeDoc);
    return new Document(this.key, version, this.value, {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  isEqual(</span>other: Mutation): boolean {
<span class="cstat-no" title="statement not covered" >    return (</span>
...
&nbsp;
  ...
  private localTransformResults(
    ...
    for (const fieldTransform of this.fieldTransforms) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (transform instanceof ServerTimestampTransform) {
...
<span class="cstat-no" title="statement not covered" >        return fail('Encountered unknown transform: ' + transform);</span>
      }
    }
