...
<html lang="en">
<head>
    <title>Code coverage report for platform_browser/webchannel_connection.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">platform_browser</a> webchannel_connection.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">86.15% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>112/130</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>110/128</span>
      </div>
    </div>
  </div>
...
367
368
369</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">402x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1307x</span>
<span class="cline-any cline-yes">1307x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1608x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2164x</span>
<span class="cline-any cline-yes">2164x</span>
<span class="cline-any cline-yes">2164x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">7x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2157x</span>
<span class="cline-any cline-yes">2157x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >      for (const header in token.authHeaders) {</span>
<span class="cstat-no" title="statement not covered" >        if (token.authHeaders.hasOwnProperty(header)) {</span>
<span class="cstat-no" title="statement not covered" >          headers[header] = token.authHeaders[header];</span>
        }
      }
    }
          ...
          try {
            switch (xhr.getLastErrorCode()) {
              case ErrorCode.NO_ERROR:
                ...
                resolve(json);
                break;
<span class="branch-1 cbranch-no" title="branch not covered" >              case ErrorCode.TIMEOUT:</span>
<span class="cstat-no" title="statement not covered" >                log.debug(LOG_TAG, 'RPC "' + rpcName + '" timed out');</span>
...
<span class="cstat-no" title="statement not covered" >                break;</span>
              case ErrorCode.HTTP_ERROR:
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (status &gt; 0) {
                  reject(
                    new FirestoreError(
...
<span class="cstat-no" title="statement not covered" >                  log.debug(LOG_TAG, 'RPC "' + rpcName + '" failed');</span>
<span class="cstat-no" title="statement not covered" >                  reject(</span>
...
&nbsp;
    const streamBridge = new StreamBridge&lt;Req, Resp&gt;({
      sendFn: (msg: Req) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!closed) {
          if (!opened) {
...
<span class="cstat-no" title="statement not covered" >          log.debug(LOG_TAG, 'Not sending because WebChannel is closed:', msg);</span>
        }
      },
...
&nbsp;
    unguardedEventListen&lt;Error&gt;(WebChannel.EventType.ERROR, <span class="fstat-no" title="function not covered" >err =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!closed) {</span>
<span class="cstat-no" title="statement not covered" >        closed = true;</span>
<span class="cstat-no" title="statement not covered" >        log.debug(LOG_TAG, 'WebChannel transport errored:', err);</span>
<span class="cstat-no" title="statement not covered" >        streamBridge.callOnClose(</span>
          new FirestoreError(
            Code.UNAVAILABLE,
...
<span class="cstat-no" title="statement not covered" >              code = Code.INTERNAL;</span>
