...
<html lang="en">
<head>
    <title>Code coverage report for remote/remote_store.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">remote</a> remote_store.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.25% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>231/240</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">96.14% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>224/233</span>
      </div>
    </div>
  </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">7691x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7691x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">625x</span>
<span class="cline-any cline-yes">625x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">625x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2274x</span>
<span class="cline-any cline-yes">2274x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2383x</span>
<span class="cline-any cline-yes">2333x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2333x</span>
<span class="cline-any cline-yes">1717x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2999x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">661x</span>
<span class="cline-any cline-yes">661x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    objUtils.forEachNumber(
      ...
      (targetId: TargetId, filter: ExistenceFilter) =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!queryData) {
          // A watched target might have been removed already.
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
        const query = queryData.query;
        if (query.isDocumentQuery()) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (filter.count === 0) {
          ...
          const promise = this.localStore
            ...
            .then(trackedRemote =&gt; {
              if (remoteEvent.targetChanges[targetId]) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (mapping !== null) {
                  <span class="missing-if-branch" title="else path not taken" >E</span>if (mapping instanceof UpdateMapping) {
...
<span class="cstat-no" title="statement not covered" >                    trackedRemote = mapping.documents;</span>
                  }
                }
              }
&nbsp;
    ...
    return Promise.all(promises).then(() =&gt; {
      ...
      objUtils.forEachNumber(remoteEvent.targetChanges, (targetId, change) =&gt; {
        if (change.resumeToken.length &gt; 0) {
          const queryData = this.listenTargets[targetId];
          // A watched target might have been removed already.
          <span class="missing-if-branch" title="else path not taken" >E</span>if (queryData) {
  ...
  private handleTargetError(watchChange: WatchTargetChange): Promise&lt;void&gt; {
    ...
    watchChange.targetIds.forEach(targetId =&gt; {
      promiseChain = promiseChain.then(async () =&gt; {
        // A watched target might have been removed already.
        <span class="missing-if-branch" title="else path not taken" >E</span>if (objUtils.contains(this.listenTargets, targetId)) {
          delete this.listenTargets[targetId];
...
&nbsp;
    ...
    if (error &amp;&amp; this.pendingWrites.length &gt; 0) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.writeStream.handshakeComplete) {
...
<span class="cstat-no" title="statement not covered" >        errorHandling = this.handleHandshakeError(error!);</span>
      }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private async handleHandshakeError(</span>error: FirestoreError): Promise&lt;void&gt; {
    // Reset the token if it's a permanent error or the error code is
    // ABORTED, signaling the write stream is no longer valid.
<span class="cstat-no" title="statement not covered" >    if (isPermanentError(error.code) || error.code === Code.ABORTED) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.writeStream.lastStreamToken = emptyByteString();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.localStore.setLastStreamToken(emptyByteString());</span>
    } else {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isNetworkEnabled()) {
