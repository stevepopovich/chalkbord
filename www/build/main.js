...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return GSUser; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return UserType; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__types_utils_type__ = __webpack_require__(348);
...
var GSUser = (function () {
    function GSUser(email, userType) {
        this.id = __WEBPACK_IMPORTED_MODULE_3__types_utils_type__["a" /* Guid */].newGuid();
        this.email = email;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_type__ = __webpack_require__(348);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(429);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_draggable__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_in_app_browser__ = __webpack_require__(468);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_storage__ = __webpack_require__(477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_component__ = __webpack_require__(481);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_consumer_consumer_component__ = __webpack_require__(549);
...
var UserSignUpComponent = (function () {
    function UserSignUpComponent(formBuilder, auth, viewControl) {
        this.formBuilder = formBuilder;
        this.auth = auth;
        this.viewControl = viewControl;
    ...
    UserSignUpComponent.prototype.signUp = function () {
        ...
        if (!this.signingUp) {
            ...
            if (this.userFormGroup.get("isRestuarant").value)
                userType = __WEBPACK_IMPORTED_MODULE_2__services_authorization_service__["c" /* UserType */].Restaurant;
            else
                userType = __WEBPACK_IMPORTED_MODULE_2__services_authorization_service__["c" /* UserType */].Consumer;
                ...
                if (!methods || methods.length < 1) {
                    _this.auth.signUpUser(email_1, password_1).then(function () {
                        _this.auth.signIn(email_1, password_1, true).then(function () {
                            var newUser = new __WEBPACK_IMPORTED_MODULE_2__services_authorization_service__["b" /* GSUser */](email_1, userType);
                            _this.auth.currentUser = newUser;
                            _this.auth.userCollection.doc(newUser.id).set(newUser.getAsPlainObject());
                            _this.viewControl.setConsumerView(); //will destory this
