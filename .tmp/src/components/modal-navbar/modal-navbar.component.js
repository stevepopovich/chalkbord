        ...
        toast.onDidDismiss(function (data, dismissType) {
            ...
            if (dismissType == "close") {
                if (_this.organizationModal) {
                    _this.deviceService.putBooleanSetting(LoginKeyss.rememberMeRestKey, false);
                    _this.viewControllerService.setBrowserHome();
                }
                else {
                    _this.deviceService.putBooleanSetting(LoginKeyss.rememberMeUserKey, false);
