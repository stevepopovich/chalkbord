...
var ConsumerLandingComponent = (function () {
    ...
    ConsumerLandingComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.deviceService.getSetting(LoginKeys.rememberMeUserKey).then(function (rememberMe) {
            if (rememberMe) {
                _this.deviceService.getUserEmailPasswordFromLocalStorage(LoginKeys.userEmailPasswordComboKey).then(function (emailPasswordTup) {
                    if (emailPasswordTup) {
